...
public class DBConn {
    ...
    static String database_scheme = Config.getValue("database_scheme");
    static String user = Config.getValue("database_username");
    static String password = Config.getValue("database_password");
    static String url = "jdbc:mysql://127.0.0.1:3306/" + database_scheme
    ...
    public static void main(String[] args) {
        ...
        conn.executeUpdate("insert into user values('???????????????????','fengjie')");
        conn.close();
    }
}
